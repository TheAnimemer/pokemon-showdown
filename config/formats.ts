...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Quick Claw', 'Light Clay', 'Razor Fang', 'Assist', 'Baton Pass', 'Last Respects', 'Shed Tail', 'Megalite',
		],
	},
	{
	...
	},
	{
		...
		unbanlist: [
			...
			'Maractus', 'Maushold', 'Oricorio-Pom-Pom', 'Overqwil', 'Shedinja', 'Stoutland', 'Sylveon', 'Toxapex', 'Toxicroak', 'Uxie', 'Weavile', 'Yanmega',
		],
		// Stupid hardcode
		onValidateSet(set, format, setHas, teamHas) {
			if (set.item) {
	...
	},
	{
		...
		banlist: ['ND OU', 'ND UUBL', 'Drizzle', 'Drought'],
	},
	{
	...
	},
	{
		...
		restricted: [
			'Fu Kage', 'Mu Kata', 'Arceus', 'Blastoise-Mega', 'Blaziken-Mega', 'Calyrex-Ice', 'Chi-Yu', 'Chien-Pao', 'Darmanitan-Galar',
			'Deoxys-Normal', 'Deoxys-Defense', 'Deoxys-Speed', 'Dialga', 'Dialga-Origin', 'Dracovish',
	...
	{
		name: "[Gen 9] National Dex Test Tier",
		mod: 'testtier',
		ruleset: ['Standard NatDex', 'Terastal Clause'],
		banlist: [
			'ND Uber', 'ND AG', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'King\'s Rock',
