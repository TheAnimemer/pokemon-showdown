export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	salamence: {
		...
		evoLevel: 50,
		eggGroups: ["Dragon"],
		otherFormes: ["Salamence-Mega", "Salamence-Tanoso"],
		formeOrder: ["Salamence", "Salamence-Mega", "Salamence-Tanoso"],
	},
	salamencemega: {
		num: 373,
		name: "Salamence-Mega",
	...
	gallade: {
		...
		evoItem: "Dawn Stone",
		eggGroups: ["Human-Like", "Amorphous"],
		otherFormes: ["Gallade-Mega", "Gallade-Tanoso"],
		formeOrder: ["Gallade", "Gallade-Mega", "Gallade-Tanoso"],
	},
	gallademega: {
		num: 475,
		name: "Gallade-Mega",
	...
	cormatose: {
		...
		abilities: {0: "Pixilate", H: "Magic Guard"},
		heightm: 3.5,
		weightkg: 739.4,
		color: "Gray",
		eggGroups: ["Tanoso", "Undiscovered"],
	...
	satyralpa: {
		...
		abilities: {0: "Gorilla Tactics", H: "Adaptability"},
		heightm: 2.4,
		weightkg: 113.4,
		color: "Green",
		eggGroups: ["Tanoso", "Field"],
	...
	bakurana: {
		...
		abilities: {0: "Unaware", H: "Earth Eater"},
		heightm: 3,
		weightkg: 455,
		color: "Gray",
		eggGroups: ["Tanoso", "Dragon"],
	...
	saruglace: {
		...
		abilities: {0: "Refrigerate", H: "Technician"},
		heightm: 1.5,
		weightkg: 75,
		color: "Blue",
		eggGroups: ["Tanoso", "Field"],
	...
	scallywatt: {
		...
		weightkg: 75,
		color: "Blue",
		eggGroups: ["Tanoso", "Water 1"],
	},
	levireap: {
		num: -1011,
		name: "Levireap",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 80, atk: 60, def: 65, spa: 122, spd: 65, spe: 128},
	...
	enerwraith: {
		...
		abilities: {0: "Cursed Body", H: "Emergency Exit"},
		heightm: 1,
		weightkg: 60,
		color: "Yellow",
		eggGroups: ["Tanoso", "Field"],
	...
	infestalk: {
		...
		abilities: {0: "Harvest", H: "Regenerator"},
		heightm: 0.5,
		weightkg: 2,
		color: "Green",
		eggGroups: ["Tanoso", "Bug"],
	},
	impharie: {
		num: -1014,
		name: "Impharie",
		...
		abilities: {0: "Dazzling", H: "Flame Body"},
		heightm: 1,
		weightkg: 10,
		color: "Red",
		eggGroups: ["Tanoso", "Field"],
	...
	laminight: {
		...
		abilities: {0: "Soothing Starlight", H: "Stall"},
		heightm: 11,
		weightkg: 0.1,
		color: "Black",
		eggGroups: ["Tanoso", "Amorphous"],
	},
	decidueyemega: {
		num: 724,
		name: "Decidueye-Mega",
	...
	froslassmega: {
		...
		weightkg: 40,
		color: "White",
		eggGroups: ["Tanoso", "Fairy", "Mineral"],
	...
	cryoctagon: {
		...
		eggGroups: ["Tanoso", "Mineral"],
	},
	ragik: {
		num: -1023,
		name: "Ragik",
		types: ["Bug", "Poison"],
		baseStats: {hp: 78, atk: 130, def: 55, spa: 94, spd: 55, spe: 126},
		abilities: {0: "Compound Eyes", 1: "Smoldering End", H: "Toxic Debris"},
		heightm: 0.2,
		weightkg: 10,
		color: "Purple",
		eggGroups: ["Tanoso", "Bug"],
	...
	pallapad: {
		...
		name: "Pallapad",
		types: ["Dark", "Fairy"],
		baseStats: {hp: 125, atk: 95, def: 73, spa: 77, spd: 85, spe: 77},
	...
	magnezonemega: {
		...
		types: ["Electric", "Steel"],
		gender: "N",
		baseStats: {hp: 70, atk: 70, def: 150, spa: 155, spd: 115, spe: 75},
		abilities: {0: "Magnet Pull"},
		heightm: 1.9,
		weightkg: 551,
		color: "Gray",
	...
	delphoxtanoso: {
		...
		abilities: {0: "Magician", H: "Misty Surge"},
		heightm: 1.5,
		weightkg: 39,
		color: "Pink",
		eggGroups: ["Tanoso", "Field"],
	...
	galvatrox: {
		...
		name: "Galvatrox",
		types: ["Electric", "Poison"],
		baseStats: {hp: 85, atk: 90, def: 76, spa: 124, spd: 76, spe: 97},
		abilities: {0: "Punk Rock", 1: "Electric Surge", H: "Technician"},
		heightm: 2.1,
		weightkg: 70,
		color: "Purple",
		prevo: "Toxtricity",
	...
	spirition: {
		...
		baseStats: {hp: 91, atk: 90, def: 72, spa: 108, spd: 90, spe: 129},
		abilities: {0: "Justified"},
		heightm: 4.2,
		weightkg: 245,
		color: "Purple",
	...
	delphoxtanosomega: {
		...
		types: ["Fairy", "Normal"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 80, atk: 93, def: 79, spa: 145, spd: 122, spe: 115},
	...
	witheroot: {
		...
		weightkg: 848,
		color: "Green",
		eggGroups: ["Tanoso", "Grass"],
	},
	salamencetanoso: {
		num: 373,
		name: "Salamence-Tanoso",
		baseSpecies: "Salamence",
		forme: "Tanoso",
		types: ["Dragon", "Ground"],
		baseStats: {hp: 110, atk: 135, def: 90, spa: 85, spd: 90, spe: 90},
		abilities: {0: "Armor Tail", H: "Defiant"},
		heightm: 1.8,
		weightkg: 122,
		color: "Gray",
		prevo: "Placeholder",
	...
	primarinamega: {
		...
		forme: "Mega",
		types: ["Water", "Fairy"],
		baseStats: {hp: 80, atk: 89, def: 89, spa: 161, spd: 141, spe: 70},
		abilities: {0: "Hydraulize"},
		heightm: 2,
		weightkg: 64,
		color: "Blue",
		eggGroups: ["Tanoso", "Water 1", "Field"],
	...
	incineroarmega: {
		...
		forme: "Mega",
		types: ["Fire", "Dark"],
		baseStats: {hp: 95, atk: 125, def: 135, spa: 100, spd: 100, spe: 85},
		abilities: {0: "Intimidate"},
		heightm: 2,
		weightkg: 110,
		color: "Red",
	...
	shenmiside: {
		...
		name: "Shenmiside",
		types: ["Ghost", "Steel"],
		baseStats: {hp: 95, atk: 70, def: 95, spa: 70, spd: 115, spe: 80},
	...
	basalalt: {
		...
		name: "Basalalt",
		types: ["Grass", "Rock"],
		baseStats: {hp: 106, atk: 53, def: 111, spa: 43, spd: 94, spe: 65},
		abilities: {0: "Sturdy", 1: "Immunity", H: "Creeping Leaves"},
		heightm: 4,
		weightkg: 800,
		color: "Green",
		eggGroups: ["Tanoso", "Mineral", "Grass"],
	},
	galladetanoso: {
		num: 475,
		name: "Gallade-Tanoso",
		...
		forme: "Tanoso",
		types: ["Electric", "Ice"],
		baseStats: {hp: 78, atk: 135, def: 75, spa: 45, spd: 95, spe: 90},
		abilities: {0: "Steadfast", 1: "Sharpness", H: "Justified"},
		heightm: 1.6,
		weightkg: 60,
		color: "Yellow",
		prevo: "Placeholder",
		eggGroups: ["Tanoso", "Human-Like", "Amorphous"],
	},
	lickilickymega: {
		num: 463,
		...
		forme: "Mega",
		types: ["Normal"],
		baseStats: {hp: 110, atk: 115, def: 125, spa: 110, spd: 125, spe: 30},
	...
	umbra: {
		...
		name: "Umbra",
		types: ["Dark", "Psychic"],
		baseStats: {hp: 80, atk: 121, def: 60, spa: 121, spd: 84, spe: 84},
		abilities: {0: "Psychic Surge", 1: "Weak Armor", H: "Adaptability"},
		heightm: 1.5,
		weightkg: 120,
		color: "Pink",
		eggGroups: ["Tanoso", "Undiscovered"],
	...
	regielekimega: {
		...
		forme: "Mega",
		types: ["Electric"],
		baseStats: {hp: 80, atk: 150, def: 25, spa: 150, spd: 25, spe: 250},
		abilities: {0: "Electric Surge"},
		heightm: 3,
		weightkg: 0.1,
		color: "Yellow",
	...
	stratoll: {
		...
		name: "Stratoll",
		types: ["Rock", "Flying"],
		baseStats: {hp: 100, atk: 108, def: 142, spa: 45, spd: 45, spe: 80},
		abilities: {0: "Mold Breaker", 1: "Cloud Nine", H: "Huge Guard"},
		heightm: 24,
		weightkg: 955,
		color: "Pink",
		eggGroups: ["Tanoso", "Mineral", "Water 3"],
	},
	scaldra: {
		num: -1036,
		name: "Scaldra",
		...
		abilities: {0: "White Smoke", H: "Dazzling"},
		heightm: 0.5,
		weightkg: 40,
		color: "Blue",
		eggGroups: ["Tanoso", "Water 2"],
	},
	serposa: {
		num: -1037,
		name: "Serposa",
		types: ["Water", "Fairy"],
		baseStats: {hp: 79, atk: 72, def: 92, spa: 110, spd: 65, spe: 122},
		abilities: {0: "Sweet Veil", H: "Dazzling"},
		heightm: 0.3,
		weightkg: 36,
		color: "Pink",
		eggGroups: ["Tanoso", "Water 2"],
	...
	regidragomega: {
		...
		forme: "Mega",
		types: ["Dragon"],
		baseStats: {hp: 200, atk: 125, def: 75, spa: 125, spd: 75, spe: 80},
		abilities: {0: "Dragon's Maw"},
		heightm: 10,
		weightkg: 980,
		color: "Green",
	...
	zangoosemega: {
		...
		forme: "Mega",
		types: ["Normal", "Fighting"],
		baseStats: {hp: 73, atk: 140, def: 90, spa: 65, spd: 80, spe: 110},
		abilities: {0: "Guts"},
		heightm: 1.5,
		weightkg: 60,
		color: "White",
	...
	googoyle: {
		...
		name: "Googoyle",
		types: ["Dragon", "Rock"],
		baseStats: {hp: 90, atk: 110, def: 140, spa: 100, spd: 75, spe: 85},
		abilities: {0: "Weak Armor", 1: "Sheer Force", H: "Rough Skin"},
		heightm: 3,
		weightkg: 238,
		color: "Brown",
		eggGroups: ["Tanoso", "Dragon"],
	...
	mimesr: {
		...
		name: "Mime Sr.",
		types: ["Psychic", "Ghost"],
		baseStats: {hp: 60, atk: 60, def: 55, spa: 108, spd: 95, spe: 142},
		abilities: {0: "Soundproof", 1: "Filter", H: "Technician"},
		heightm: 2,
		weightkg: 58,
		color: "White",
	...
	piracron: {
		...
		name: "Piracron",
		types: ["Rock", "Dragon"],
		baseStats: {hp: 100, atk: 110, def: 105, spa: 80, spd: 75, spe: 100},
		abilities: {0: "Rough Skin"},
		heightm: 2,
		weightkg: 305,
		color: "Gray",
		eggGroups: ["Tanoso", "Dragon", "Mineral"],
	},
	kazehiro: {
		num: -1042,
		name: "Kazehiro",
	...
	ribbixie: {
		...
		abilities: {0: "Water Absorb", 1: "Regenerator", H: "Magic Bounce"},
		heightm: 1,
		weightkg: 105,
		color: "Pink",
		eggGroups: ["Tanoso", "Water 1", "Field"],
	...
	mukata: {
		...
		name: "Mu Kata",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 120, atk: 100, def: 135, spa: 100, spd: 135, spe: 80},
		abilities: {0: "Remedial Ooze"},
		heightm: 4.5,
		weightkg: 280,
		color: "Green",
		tags: ["Restricted Legendary"],
	...
	spirazuma: {
		...
		name: "Spirazuma",
		types: ["Ghost", "Electric"],
		baseStats: {hp: 115, atk: 130, def: 100, spa: 70, spd: 80, spe: 100},
		abilities: {0: "Fair Duel", H: "Pressure"},
		heightm: 3,
		weightkg: 380,
		color: "Purple",
		eggGroups: ["Tanoso", "Monster"],
	...
	katamasu: {
		...
		name: "Katamasu",
		types: ["Normal"],
		baseStats: {hp: 90, atk: 85, def: 135, spa: 125, spd: 90, spe: 60},
		abilities: {0: "Defeatist", 1: "Gullible", H: "Unaware"},
		heightm: 1.8,
		weightkg: 60,
		color: "Gray",
		eggGroups: ["Tanoso", "Mineral", "Field"],
	},
	katamasuinfluenced: {
		num: -1048,
		name: "Katamasu-Influenced",
		types: ["Normal"],
		baseStats: {hp: 90, atk: 142, def: 110, spa: 75, spd: 67, spe: 101},
		abilities: {0: "Gullible"},
		heightm: 2.6,
		weightkg: 120,
		color: "Gray",
		eggGroups: ["Tanoso", "Mineral", "Field"],
