export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	sceptiletanosomega: {
		...
		baseStats: {hp: 65, atk: 155, def: 100, spa: 108, spd: 101, spe: 101},
		abilities: {0: "Transistor"},
		heightm: 2,
		weightkg: 75,
		color: "Yellow",
	...
	delphoxtanosomega: {
		...
		types: ["Fairy", "Normal"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 80, atk: 88, def: 79, spa: 145, spd: 122, spe: 120},
	...
	diatridon: {
		...
		name: "Diatridon",
		types: ["Water", "Steel"],
		baseStats: {hp: 100, atk: 100, def: 85, spa: 100, spd: 95, spe: 120},
	...
	scaldra: {
		...
		name: "Scaldra",
		types: ["Water", "Fire"],
		baseStats: {hp: 75, atk: 117, def: 70, spa: 86, spd: 70, spe: 122},
	...
	serposa: {
		...
		name: "Serposa",
		types: ["Water", "Fairy"],
		baseStats: {hp: 79, atk: 64, def: 92, spa: 117, spd: 66, spe: 122},
